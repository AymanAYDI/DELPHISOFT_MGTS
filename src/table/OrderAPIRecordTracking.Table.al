table 50074 "Order API Record Tracking"
{
    // Mgts10.00.01.00 | 11.01.2020 | Order API Management
    // 
    // Mgts10.00.01.02 | 24.02.2020 | Order API Management : Add field and key : Sent Deal
    // 
    // ------------------------------------------------------------------------------------------
    // Sign    : Maria Hr. Hristova = mhh
    // Version : MGTS10.00.012
    // 
    // ------------------------------------------------------------------------------------------
    // No.    Version          Date        Sign    Description
    // ------------------------------------------------------------------------------------------
    // 001    MGTS10.00.012    25.09.20    mhh     List of changes:
    //                                              Added new field: 23 "Completed"
    // ------------------------------------------------------------------------------------------
    ...
    fields
    {
        ...
        field(6;"ACO Supplier ERP Name";Text[50])
        {
