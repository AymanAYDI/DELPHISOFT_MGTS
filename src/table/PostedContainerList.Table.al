table 50085 "DEL Posted Container List"
{

    Caption = 'Posted Container List';
    ...
    fields
    {
        ...
        field(37; "Special Order Sales No."; Code[20])
        {
            ...
            //TODO TableRelation = IF ("Special Order Sales No."=CONST(YES)) "Sales Header"."No." WHERE ("Document Type"=CONST(Order));
        }
        ...
        field(101; "Receipt No."; Code[20])
        {
            Caption = 'Receipt No.';
            TableRelation = "Purch. Rcpt. Header"."No.";

        }
        field(102; "Purchase Invoice No."; Code[20])
        {
            Caption = 'Purchase Invoice No.';
            TableRelation = "Purch. Inv. Header"."No.";
        }
        field(103; "Sales Invoice No."; Code[20])
        {
            Caption = 'Sales Invoice No.';
            TableRelation = "Sales Invoice Header"."No.";
        }
        field(104; "Meeting Date"; Date)
        {
            Caption = 'Meeting Date';
        }
        field(105; "Invoice Status"; Option)
        {
            Caption = 'Invoice Status';
            OptionCaption = ' ,Awaiting Invoicing,Invoiced';
            OptionMembers = " ","Awaiting Invoicing",Invoiced;
        }
    }
