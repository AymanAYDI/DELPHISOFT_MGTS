report 50019 "Delete document Sales/Purchase"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(DataItem1100113009; Table36)
        {
            ...
            dataitem(DataItem1100113000; Table37)
            {
        ...
        dataitem(DataItem1100113010;Table38)
        {
            ...
            dataitem(DataItem1100113021;Table39)
            {
