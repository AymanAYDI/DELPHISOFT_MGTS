report 50068 "DEL Stand. Sales - Order Conf." //TODO ID=205 
{
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(Location_Code; Line."Location Code")
            {
            }
            ...
            column(RequestedDeliveryDate; FORMAT(Header."Requested Delivery Date", 0, '<Day,2>.<Month,2>.<Year4>'))
            {
            }
            column(RequestedDeliveryDateCaption; Header.FIELDCAPTION("Requested Delivery Date"))
            {
            }
            ...
            column(DocExterne; Header."External Document No.")
            {
            }
            column(DocExterne_Caption; Header.FIELDCAPTION(Header."External Document No."))
            {
            }
            ...
            column(Cost_Name; Header."Sell-to Customer Name")
            {
            }
            column(Cost_Contact; Header."Sell-to Contact")
            {
            }
            column(Cost_Adress; Header."Sell-to Address")
            {
            }
            column(Cost_country; Header."Sell-to Country/Region Code")
            {
            }
            column(Cost_Post; Header."Sell-to Post Code" + ' ' + Header."Sell-to City")
            {
            }
            column(Reference; Header."Your Reference")
            {
            }
            column(Reference_Caption; Header."Your Reference")
            {
            }
