report 50025 "Export Vente"
{
    ...
    begin
        IF SensLine = '+' THEN BEGIN
            ...
            ExportVente.Ean := CorLengthTxt(Item_Rec."Code EAN 13", 13);                   //11
            ExportVente."Code Marque" := CorLengthTxt(Item_Rec.Marque, 10);                          //12
            ...
            ExportVente."Groupe marchandise B.U" := CorLengthTxt(Item_Rec."Product Group Code", 30);           //21
        ...
        IF SensLine = '-' THEN BEGIN
            ...
            ExportVente.Ean := CorLengthTxt(Item_Rec."Code EAN 13", 13);
            ExportVente."Code Marque" := CorLengthTxt(Item_Rec.Marque, 10);
            ...
            ExportVente."Groupe marchandise B.U" := CorLengthTxt(Item_Rec."Product Group Code", 30);
