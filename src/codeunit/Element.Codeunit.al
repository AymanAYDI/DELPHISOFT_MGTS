codeunit 50021 Element
{
    ...
    // CHG02                            16.09.08   Added already existing invoices inclusion handling
    // CHG03                            06.04.09   Update
    // CHG04                            20.04.09   Modified FNC_Insert_Element
    // CHG05                            11.05.09   Modified Add_Sales_Invoice, Add_Sales_Cr_Memo, Add_Purch_Invoice, Add_Purch_Cr_Memo
    // CHG06                            18.05.09   Added FNC_Get_Quantity function
    // GRC01                            23.10.09   update table logistic with BRNO
    // GRC02                            02.11.09   create fonction FNC_Add_New_CreditM
    // CHG07                            11.03.10   redéfinition de element.date pour les ACO prévues
    // GRC03                            08.06.10   add n.clien on chaque élément
    // STG01                            24.06.11   generate only lines with quantity
    ...
    var
        ...
        Setup: Record "50000";
        DealShipmentConnection_Cu: Codeunit "50027";
    ...
    [Scope('Internal')]
    procedure FNC_Add_ACO(Deal_ID_Co_Par: Code[20]; ACO_Re_Par: Record "38") element_ID_Co_Ret: Code[20]
    var
    ...
    [Scope('Internal')]
    procedure FNC_Add_ACO_From_Invoice(Deal_ID_Co_Par: Code[20]; PurchaseInvoiceHeader_Re_Par: Record "122") element_ID_Co_Ret: Code[20]
    var
        isPlanned_Op_Loc: Option;
        element_Re_Loc: Record "50021";
        deal_Re_Loc: Record "50020";
    ...
    [Scope('Internal')]
    procedure FNC_Add_VCO(Deal_ID_Co_Par: Code[20]; ACO_Co_Par: Code[20]; VCO_Re_Par: Record "36")
    var
        isPlanned_Op_Loc: Option;
        element_Re_Loc: Record "50021";
        element_ID_Co_Loc: Code[20];
    ...
    [Scope('Internal')]
    procedure FNC_Add_BR(Deal_ID_Co_Par: Code[20]; BR_Header_Re_Par: Record "120"; DealShipmentNo_Co_Par: Code[20]; Add_Variant_Op_Par: Option New,Existing)
    var
        element_Re_Loc: Record "50021";
    ...
    [Scope('Internal')]
    procedure FNC_Add_New_Invoice(DealShipmentSelection_Re_Par: Record "50031"; SplittIndex_Int_Par: Integer) element_ID_Co_Ret: Code[20]
    var
        element_ID_Co_Loc: Code[20];
    ...
    [Scope('Internal')]
    procedure FNC_Add_New_Invoice_Connection(Element_ID_Co_Par: Code[20]; DealShipmentSelection_Re_Par: Record "50031"; ConnectionType_Op_Par: Option Element,Shipment; SplitIndex_Int_Par: Integer)
    var
        element_ID_Co_Loc: Code[20];
        genJournalLine_Re_Loc: Record "81";
        element_Re_Loc: Record "50021";
    ...
    [Scope('Internal')]
    procedure FNC_Add_Provision(sps_Re_Par: Record "50042"; isExtourne_Bo_Par: Boolean) element_ID_Co_Ret: Code[20]
    var
        element_ID_Co_Loc: Code[20];
        element_Re_Loc: Record "50021";
    ...
    [Scope('Internal')]
    procedure FNC_Add_Provision_Connection(Element_ID_Co_Par: Code[20]; sps_Re_Par: Record "50042"; ConnectionType_Op_Par: Option Element,Shipment)
    var
        element_ID_Co_Loc: Code[20];
        genJournalLine_Re_Loc: Record "81";
        element_Re_Loc: Record "50021";
    ...
    [Scope('Internal')]
    procedure FNC_Add_Purchase_Invoice(Deal_ID_Co_Par: Code[20]; PurchaseInvoiceHeader_Re_Par: Record "122"; ShipmentNo_Co_Par: Code[20]; Add_Variant_Op_Par: Option New,Existing)
    var
        element_Re_Loc: Record "50021";
        element_ID_Loc: Code[20];
        dealShipmentSelection_Re_Loc: Record "50031";
    ...
    [Scope('Internal')]
    procedure FNC_Add_Purch_Cr_Memo(Deal_ID_Co_Par: Code[20]; creditMemoHeader_Re_Par: Record "124"; ShipmentNo_Co_Par: Code[20]; Add_Variant_Op_Par: Option New,Existing)
    var
        element_Re_Loc: Record "50021";
        element_ID_Loc: Code[20];
        dealShipmentSelection_Re_Loc: Record "50031";
    ...
    [Scope('Internal')]
    procedure FNC_Add_Sales_Invoice(Deal_ID_Co_Par: Code[20]; SalesInvoiceHeader_Re_Par: Record "112"; ShipmentNo_Co_Par: Code[20]; Add_Variant_Op_Par: Option New,Existing)
    var
        element_Re_Loc: Record "50021";
        element_ID_Loc: Code[20];
        dealShipmentSelection_Re_Loc: Record "50031";
    ...
    [Scope('Internal')]
    procedure FNC_Add_Sales_Cr_Memo(Deal_ID_Co_Par: Code[20]; creditMemoHeader_Re_Par: Record "114"; ShipmentNo_Co_Par: Code[20]; Add_Variant_Op_Par: Option New,Existing)
    var
        element_Re_Loc: Record "50021";
        element_ID_Loc: Code[20];
        dealShipmentSelection_Re_Loc: Record "50031";
    ...
    var
        ...
        BRElement_Re_Loc: Record "50021";
        element_ID_Loc: Code[20];
        VCOElement_Re_Loc: Record "50021";
    ...
    [Scope('Internal')]
    procedure FNC_Set_Element(var element_Re_Par: Record "50021"; element_ID_Co_Par: Code[20])
    begin
    ...
    [Scope('Internal')]
    procedure FNC_Add_New_CreditM(DealShipmentSelection_Re_Par: Record "50031"; SplittIndex_Int_Par: Integer) element_ID_Co_Ret: Code[20]
    var
        element_ID_Co_Loc: Code[20];
        genJournalLine_Re_Loc: Record "81";
        element_Re_Loc: Record "50021";
