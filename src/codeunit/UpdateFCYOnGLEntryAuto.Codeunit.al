codeunit 50009 "Update FCY On G/L Entry Auto"
{
    ...
    // T-00737                          05.10.15   Automatisation du traitement des devises initiales
    ...
    begin
        ...
        */
                    ...
                    glEntry_Re_Loc."Source Type"::"Bank Account":
                        BEGIN
                            IF baLedgerEntry_Re_Loc.GET(glEntry_Re_Loc."Entry No.") THEN BEGIN
                                ...
                                IF baLedgerEntry_Re_Loc.Amount <> 0 THEN //OLD T-00737 BEGIN
                                                                         //START CHG01
                                ...
                                //STOP CHG01
                                //OLD T-00737 END ELSE BEGIN
                                //OLD T-00737  MESSAGE('Amount is 0 on Bank Account Ledger entry >%1< and exchange rate can ' +
                                //OLD T-00737  'therefore not be calculated !', glEntry_Re_Loc."Entry No.");
                                //OLD T-00737 END;
        ...
        //OLD T-00737 MESSAGE('Mise à jour effectuée !');
